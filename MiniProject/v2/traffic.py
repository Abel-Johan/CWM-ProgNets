    	...
    	try:
    	    ...
    	    if resp:
    	        ...
    	        if p4traffic:
                    ...
                    # simulate the 
                    newcar, p4traffic.Junction_Timer, p4traffic.Consecutive_Timer = simulate(p4traffic.Green_Car, p4traffic.Junction_Timer, p4traffic.Consecutive_Timer) 
                    ...
                    if p4traffic.Green_Light == 0x01:   	            	    
                        j1_car = newcar
                        p4traffic.New_green_car = addn_j1_car
                    elif p4traffic.Green_Light == 0x02:
                        j2_car = newcar
                        p4traffic.New_green_car = addn_j2_car
                    elif p4traffic.Green_Light == 0x03:
                        j3_car = newcar
                        p4traffic.New_green_car = addn_j3_car
                    elif p4traffic.Green_Light == 0x04:
                        j4_car = newcar
                        p4traffic.New_green_car = addn_j4_car
