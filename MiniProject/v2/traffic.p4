...
control MyIngress(inout headers hdr,
    ...
    action quiet(bit<8> green_light, bit<8> green_car) {
        hdr.p4traffic.green_light = green_light;
    ...
    apply {
    	if (hdr.p4traffic.isValid()) {
            ...
            //    check_if_should_change(hdr.p4traffic.green_light, hdr.p4traffic.new_j1_car);
            //    quiet(hdr.p4traffic.green_light, hdr.p4traffic.j1_car);
            //} else if (hdr.p4traffic.green_light == 0x02) {
            //    check_if_should_change(hdr.p4traffic.green_light, hdr.p4traffic.new_j2_car);
            //    quiet(hdr.p4traffic.green_light, hdr.p4traffic.j2_car);
            //} else if (hdr.p4traffic.green_light == 0x03) {
            //    check_if_should_change(hdr.p4traffic.green_light, hdr.p4traffic.new_j3_car);
            //    quiet(hdr.p4traffic.green_light, hdr.p4traffic.j3_car);
            //} else if (hdr.p4traffic.green_light == 0x04) {
            //    check_if_should_change(hdr.p4traffic.green_light, hdr.p4traffic.new_j4_car);
            //    quiet(hdr.p4traffic.green_light, hdr.p4traffic.j4_car);
            //}
        } else {
            operation_drop();
        }
